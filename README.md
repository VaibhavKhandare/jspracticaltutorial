# JavaScript to Express.js Ecommerce Backend Tutorial
...
node 01-datatypes/02_strings.js
node 01-datatypes/03_booleans.js
node 01-datatypes/04_arrays.js
...
### 01 - Data Types
Basic JavaScript data types with practical examples:
- Numbers (`01_numbers.js`)
- Strings (`02_strings.js`)
- Booleans (`03_booleans.js`)
- Arrays (`04_arrays.js`)
- Maps (`05_maps.js`)
- Functions (`06_Functions.js`)
- Classes (`07_Class.js`)
